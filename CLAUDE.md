...
**Projet terminé.** Collecte close le 2026-08-24, analyse close le 2026-08-26, **mémoire remis au directeur le 2026-08-31** : le document envoyé est `Mémoire Videt Léo IREN.pdf`, à la racine du dépôt, avec son `.docx` source. 24 exécutions, 177 séries, 26 550 manches, 47,27 $ ; rejeu 24/24, intégrité 24/24, zéro action par défaut. Les quatre hypothèses sont instrumentées, les trois chapitres sont rédigés, la bibliographie est unifiée en auteur-date, les 14 tableaux et 4 figures sont numérotés et légendés. Il ne reste ni collecte, ni analyse, ni rédaction. Résultats et inventaire complet des données dans `memoire/resultats.md`, données versionnées dans `donnees/`. La documentation de référence :
